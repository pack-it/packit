...
pub fn repository_package(package_name: &PackageName, manager: &RepositoryManager) -> ! {
...
pub fn repository_package_version(package_id: &PackageId, manager: &RepositoryManager) -> ! {
