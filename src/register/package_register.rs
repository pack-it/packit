...
use crate::{
    ...
    utils::{constants::REGISTER_FILENAME, ioerror::IOResultExt},
};
...
impl PackageRegister {
    ...
    pub fn from(path: &Path) -> Result<Self> {
        ...
        // Read data from file
        let file_content = fs::read_to_string(path).err_with_path("read", path)?;
...
pub mod tests {
    ...
    fn add_package() {
        ...
        dependency_ids.insert(create_package_id("B@2.72"));
        ...
        let package_b_id = create_package_id("B@2.72");
