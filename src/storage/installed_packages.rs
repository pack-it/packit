...
pub struct InstalledPackageStorage {
    ...
    pub installed_packages: Vec<InstalledPackage>, // TODO: Check to hashmap
}
...
impl InstalledPackageStorage {
    ...
    pub fn remove_package_version(&mut self, package_id: &PackageId) {
        self.installed_packages.retain(|package| package.package_id != *package_id);
    ...
    pub fn remove_package(&mut self, package_name: &str) {
        ...
        // TODO: Replace with call to remove_package_version (for each package_id), when hashmap implementation is made
        self.installed_packages.retain(|package| package.package_id.name != package_name);

        // Remove the packages as a dependents of other remaining packages
    ...
    pub fn get_package_mut(&mut self, package_id: &PackageId) -> Option<&mut InstalledPackage> {
        for installed_package in self.installed_packages.iter_mut() {
