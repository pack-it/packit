...
- When packages are specified for the verifier checks, only those are checked when doing a package related check. So the initial and general checks are now done as well.
