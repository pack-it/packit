...
When multiple versions of a package are installed and no version is specified, you will be asked if you want to uninstall all installed versions of `<PACKAGE-NAME>`.
...
Note that you can specify a version for some packages while leaving the version unspecified for others.
