...
This will result in package `htop` not being available in your PATH anymore, and thus you cannot run it anymore.
...
> [!WARNING]  
> External repositories can contain harmful content and should therefore be trusted before adding it to the configuration of Packit.
